(function (g) {
  ...
  const STRINGS = {
    en: {
      ...
      'cart.discount': 'Discount ({code}, {percent}%)',
      'cart.voucherLabel': 'Discount voucher',
      'cart.voucherPlaceholder': 'Enter code',
      'cart.voucherApply': 'Apply',
      'cart.voucherApplying': 'Applying…',
      'cart.voucherRemove': 'Remove',
      'cart.voucherApplied': 'Voucher {code} applied (−{percent}%)',
      'cart.voucherRequired': 'Enter a voucher code.',
    ...
    el: {
      ...
      'cart.discount': 'Έκπτωση ({code}, {percent}%)',
      'cart.voucherLabel': 'Κουπόνι έκπτωσης',
      'cart.voucherPlaceholder': 'Εισάγετε κωδικό',
      'cart.voucherApply': 'Εφαρμογή',
      'cart.voucherApplying': 'Εφαρμογή…',
      'cart.voucherRemove': 'Αφαίρεση',
      'cart.voucherApplied': 'Εφαρμόστηκε το κουπόνι {code} (−{percent}%)',
      'cart.voucherRequired': 'Εισάγετε κωδικό κουπονιού.',
      'cart.voucherInvalid': 'Μη έγκυρος κωδικός κουπονιού.',
      'cart.total': 'Σύνολο',
