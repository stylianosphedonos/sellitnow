(function (g) {
  ...
  const STRINGS = {
    en: {
      ...
      'cart.remove': 'Remove',
      'cart.removeAll': 'Remove all',
      'cart.removeAllConfirm': 'Remove all items from your cart?',
      'cart.removingAll': 'Removing…',
    ...
    el: {
      ...
      'cart.removeAll': 'Αφαίρεση όλων',
      'cart.removeAllConfirm': 'Να αφαιρεθούν όλα τα προϊόντα από το καλάθι;',
      'cart.removingAll': 'Αφαίρεση…',
